...
const Register: React.FC = () => {
    ...
    return (
        <div className="h-screen overflow-y-auto custom-scrollbar bg-slate-50 dark:bg-slate-900 flex flex-col py-12 sm:px-6 lg:px-8 font-sans transition-colors duration-200 relative">
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md mb-auto">
                <div className="bg-white dark:bg-slate-800 py-8 px-4 shadow-xl sm:rounded-2xl sm:px-10 border border-gray-100 dark:border-slate-700 transition-colors duration-200">
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Please fill in your details to get started.</p>
                    </div>
                    ...
                    <div className="mt-8">
                        ...
                        <div className="mt-6 text-center">
                            <button 
                                ...
                                className="text-sm font-medium text-[#120085] dark:text-blue-400 hover:text-[#0a0066] dark:hover:text-blue-300 hover:underline transition-colors bg-transparent border-none cursor-pointer focus:outline-none"
                            >
                                Sign in here
                            </button>
                        </div>
